...
let CreateRestaurantInput = class CreateRestaurantInput extends graphql_1.PickType(restaurant_entity_1.Restaurant, ['name', 'coverImage', 'address']) {
};
__decorate([
...
let CreateRestaurantOutput = class CreateRestaurantOutput extends output_dto_1.MutationOutput {
};
